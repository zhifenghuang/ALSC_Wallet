package com.wallet.widget.scanner.view;
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        net_work_textPaint.setTextSize(DensityUtil.dip2px( 18));
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawText(getContext().getString(R.string.zxing_top_hint), (frame.left + frame.right) / 2, frame.bottom + DensityUtil.dip2px( 23), textPaint);
        if (drawNetWork) {
            canvas.drawText(getContext().getString(R.string.network_excption), (frame.left + frame.right) / 2, (frame.top + frame.bottom) / 2 - DensityUtil.dip2px( 20), net_work_textPaint);
            canvas.drawText(getContext().getString(R.string.network_excption), (frame.left + frame.right) / 2, (frame.top + frame.bottom) / 2 + DensityUtil.dip2px( 20), net_work_textPaint);
        } else {
            // �����ĸ��
