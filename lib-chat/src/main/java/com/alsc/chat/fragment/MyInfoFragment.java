...
public class MyInfoFragment extends BaseFragment {
    ...
    protected void onViewCreated(View view) {
        ...
        Utils.displayAvatar(getActivity(), R.drawable.chat_default_group_avatar, mMyInfo.getAvatarUrl(), view.findViewById(R.id.ivAvatar));
    ...
    public void onReceive(HashMap<Object, Object> map) {
    ...
    public void onReceiveAvatarUrl(UploadAvatarEvent avatar) {
        ...
        if (avatar.isSuccess()) {
            mMyInfo.setAvatarUrl(avatar.getUrl());
            DataManager.getInstance().saveUser(mMyInfo);
