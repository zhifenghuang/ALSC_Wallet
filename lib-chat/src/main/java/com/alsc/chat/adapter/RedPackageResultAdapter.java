    ...
    protected void convert(@NotNull BaseViewHolder helper, @Nullable RedPackageResultFragment.RedPackageResultItem item) {
        switch (helper.getItemViewType()) {
            case 0:
                ...
                Utils.displayAvatar(mContext, R.drawable.chat_default_group_avatar, mEnvelope.getAvatarUrl(), helper.getView(R.id.ivAvatar));
                ...
                if (mEnvelope.getType() == 4) {
                    ...
                    helper.setText(R.id.tvRedPackageValue, String.format("%.2f", mEnvelope.getAmount()));
                } else {
                    if (mMySession != null) {
                        helper.setVisible(R.id.tvRedPackageValue, true)
                                .setText(R.id.tvRedPackageValue, String.format("%.2f", mMySession.getAmount()));
                    } else {
                    ...
                    if (mIsMy) {
                        ...
                        String str = mContext.getString(R.string.chat_group_red_pacage_status, mEnvelope.getSession().size() + "/" + mEnvelope.getTotalCount())
                                ...
                                String.format("%.2f", rest + 0.00000001) + "/" + mEnvelope.getAmount());
            ...
            case 1:
                ...
                helper.setText(R.id.tvName, session.getNickName())
                        ...
                        .setText(R.id.tvValue, String.format("%.2f", session.getAmount()));
                break;
        }
    }
}
