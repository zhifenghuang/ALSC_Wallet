...
//import com.alsc.chat.adapter.OldChatUserAdapter;
...
//
//public class OldChatListFragment extends ChatBaseFragment {
//
//    private OldChatUserAdapter mAdapter;
...
//        return R.layout.fragment_old_chat_list;
//    }
//
//    @Override
...
//    }
//
//    private OldChatUserAdapter getAdapter() {
//        if (mAdapter == null) {
//            mAdapter = new OldChatUserAdapter(getActivity(), DataManager.getInstance().getUser());
