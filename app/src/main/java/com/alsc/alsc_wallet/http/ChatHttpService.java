...
import com.alsc.alsc_wallet.bean.chat.EnvelopeRecordBean;
import com.alsc.alsc_wallet.bean.chat.FilterMsgBean;
import com.alsc.alsc_wallet.bean.chat.GroupBean;
import com.alsc.alsc_wallet.bean.chat.LabelBean;
import com.alsc.alsc_wallet.bean.chat.QuestionBean;
import com.alsc.alsc_wallet.bean.chat.TransferFeeBean;
...
*/
   ...
   */
    ...
    */
    ...
    Observable<BasicResponse> kickout(@Query("lang") String lang, @Part("groupId") RequestBody groupId,
                                      @Part("kickUserId") RequestBody kickUserId);
    ...
    Observable<BasicResponse<UserBean>> getUserProfile(@Query("lang") String lang, @Part("contactId") RequestBody contactId);
