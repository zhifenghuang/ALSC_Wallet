...
import com.cao.commons.bean.chat.GroupInviteBean;
...
public class MessageAdapter extends BaseQuickAdapter<BasicMessage, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, BasicMessage item) {
        ...
        if (item.isMySendMsg(mMyInfo.getUserId())) {
            ...
            setOnResendClick(helper.getView(R.id.ivResend), helper.getAdapterPosition());
            if (msgType == MessageType.TYPE_TEXT.ordinal() || msgType == MessageType.TYPE_GROUP_AT_MEMBER_MSG.ordinal()) {
                ...
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.tvRight), helper.getAdapterPosition());
                ...
                helper.setGone(R.id.llTextRight, true)
                        ...
                        .setGone(R.id.llRecommendRight, true)
                        .setGone(R.id.rlRedPackageRight, true);
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.ivPicRight), helper.getAdapterPosition());
                ...
                helper.setGone(R.id.llTextRight, true)
                        ...
                        .setGone(R.id.rlRedPackageRight, true)
                        .setGone(R.id.llRecommendRight, true);
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.llVoiceRight), helper.getAdapterPosition());
                ...
                helper.setGone(R.id.llTextRight, true)
                        ...
                        .setGone(R.id.rlRedPackageRight, true)
                        .setGone(R.id.llRecommendRight, true);
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.rlVideoRight), helper.getAdapterPosition());
                ...
                helper.setGone(R.id.llTextRight, true)
                        ...
                        .setGone(R.id.rlRedPackageRight, true)
                        .setGone(R.id.llRecommendRight, true);
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.flLocationRight), helper.getAdapterPosition());
                ...
                helper.setGone(R.id.llTextRight, true)
                        ...
                        .setGone(R.id.rlRedPackageRight, true)
                        .setGone(R.id.llRecommendRight, true);
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.llFileRight), helper.getAdapterPosition());
                ...
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.rlRedPackageRight), helper.getAdapterPosition());
                ...
                helper.setGone(R.id.llTextRight, true)
                        ...
                        .setGone(R.id.rlRedPackageRight, true)
                        .setGone(R.id.llRecommendRight, true);
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.rlTransferRight), helper.getAdapterPosition());
                ...
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.llRecommendRight), helper.getAdapterPosition());
            ...
            if (msgType == MessageType.TYPE_TEXT.ordinal() || msgType == MessageType.TYPE_GROUP_AT_MEMBER_MSG.ordinal()) {
                ...
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.llTextLeft), helper.getAdapterPosition());
            } else if (msgType == MessageType.TYPE_IMAGE.ordinal()) {
                ...
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.ivPicLeft), helper.getAdapterPosition());
                ...
                helper.setGone(R.id.llTextLeft, true)
                        ...
                        .setGone(R.id.rlInviteLeft, true)
                        .setGone(R.id.rlPicLeft, true);
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.llVoiceLeft), helper.getAdapterPosition());
                ...
                helper.setGone(R.id.llTextLeft, true)
                        ...
                        .setGone(R.id.rlInviteLeft, true)
                        .setGone(R.id.rlPicLeft, true);
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.rlVideoLeft), helper.getAdapterPosition());
                ...
                helper.setGone(R.id.llTextLeft, true)
                        ...
                        .setGone(R.id.rlInviteLeft, true)
                        .setGone(R.id.rlRedPackageLeft, true);
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.flLocationLeft), helper.getAdapterPosition());
                ...
                helper.setGone(R.id.llTextLeft, true)
                        ...
                        .setGone(R.id.rlInviteLeft, true)
                        .setGone(R.id.rlRedPackageLeft, true);
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.llFileLeft), helper.getAdapterPosition());
                ...
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.rlRedPackageLeft), helper.getAdapterPosition());
                ...
                helper.setGone(R.id.llTextLeft, true)
                        ...
                        .setGone(R.id.rlInviteLeft, true)
                        .setGone(R.id.llQuestion, true);
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.rlTransferLeft), helper.getAdapterPosition());
                ...
                helper.setGone(R.id.llTextLeft, true)
                        ...
                        .setGone(R.id.rlInviteLeft, true)
                        .setGone(R.id.llQuestion, true);
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.llRecommendLeft), helper.getAdapterPosition());
                ...
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.llQuestion), helper.getAdapterPosition());
                ...
                helper.setGone(R.id.llTextLeft, true)
                        ...
                        .setGone(R.id.rlInviteLeft, true)
                        .setGone(R.id.llQuestion, true);
                setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.llService), helper.getAdapterPosition());
                ...
                if (!TextUtils.isEmpty(item.getExtra())) {
                    ...
                    Utils.displayAvatar(mContext, R.drawable.chat_default_group_avatar, bean.getGroup().getIcon(), helper.getView(R.id.ivInviteGroupIconLeft));
                    ...
                    setOnClickListener(helper.getView(R.id.llParent), helper.getView(R.id.rlInviteLeft), helper.getAdapterPosition());
                }
            } else {
                helper.setGone(R.id.llLeft, true);
            }
    ...
    private void showRecommendMsg(ImageView iv, TextView tvNick, TextView tvId, BasicMessage item) {
        if (!TextUtils.isEmpty(item.getContent())) {
            try {
                ...
                Utils.displayAvatar(mContext, R.drawable.chat_default_group_avatar, bean.getAvatarUrl(), iv);
    ...
    protected void showUserInfo(BaseViewHolder helper, BasicMessage item) {
        if (item.isMySendMsg(mMyInfo.getUserId())) {
            ...
            Utils.displayAvatar(mContext, R.drawable.chat_default_group_avatar, mChatUser.getAvatarUrl(), helper.getView(R.id.ivLeft));
