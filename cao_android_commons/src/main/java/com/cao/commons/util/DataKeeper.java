...
import com.cao.commons.util.cipher.ByteUtil;
import com.cao.commons.util.cipher.Cipher;
import com.cao.commons.util.cipher.HexUtil;
...
public class DataKeeper {
    ...
    public static void init(Context context) {
        if (sp == null || editor == null) {
            sp = context.getSharedPreferences(SPConstants.J_SHOP,Context.MODE_PRIVATE);
            editor = sp.edit();
        }
    }
