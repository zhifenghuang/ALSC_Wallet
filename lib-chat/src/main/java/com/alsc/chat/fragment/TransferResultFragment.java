...
public class TransferResultFragment extends BaseFragment {
    ...
    protected void onViewCreated(View view) {
        ...
        setText(R.id.tvValue, getString(R.string.chat_xxx_alsc, String.format("%.2f", mEnvelope.getAmount())));
        int status = mEnvelope.getStatus();
        if (myInfo.getUserId() == mEnvelope.getUserId()) {
            Utils.displayAvatar(getActivity(), R.drawable.chat_default_group_avatar, mEnvelope.getAvatarUrl(), view.findViewById(R.id.ivAvatar));
            ...
            Utils.displayAvatar(getActivity(), R.drawable.chat_default_group_avatar, myInfo.getAvatarUrl(), view.findViewById(R.id.ivAvatar));
