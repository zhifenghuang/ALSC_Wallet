...
import com.alsc.alsc_wallet.utils.NetUtil;
...
public class ChatHttpMethods {
     ...
     * @param observer
     */
    public void kickOutUser(long groupId, long userId, HttpObserver observer) {
        ChatHttpService httpService = mRetrofit.create(ChatHttpService.class);
        Observable observable = httpService.kickout(Utils.getLanguageStr(DataManager.getInstance().getLanguage()), RequestBody.create(MediaType.parse("text/plain"), String.valueOf(groupId))
     ...
     * @param observer
     */
    public void getUserProfile(String contactId, HttpObserver observer) {
        ChatHttpService httpService = mRetrofit.create(ChatHttpService.class);
        Observable observable = httpService.getUserProfile(Utils.getLanguageStr(DataManager.getInstance().getLanguage()), RequestBody.create(MediaType.parse("text/plain"), contactId));
        toSubscribe(observable, observer);
    }
