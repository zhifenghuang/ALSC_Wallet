package com.wallet.widget.scanner;
...
public class AppConfig {
    public static final String APP_NAME = PoliceApplication.getInstance().getResources().getString(R.string.app_name_pinyin);
...
//    public static final String VERSIONNAME = MyApplication.getInstance().getResources().getString(R.string.app_version_name);
    ...
    public static final String PERSON_AVATAR_IMAGE_PATH = AppConfig.TEMP_PIC + PoliceApplication.getInstance().getResources().getString(R.string.app_name_pinyin) + "_face.jpg";
    ...
    public static String getSDPath() {
        ...
        if (sdCardExist) {
            ...
            PoliceApplication.getInstance().getApplicationContext().getCacheDir().getAbsolutePath(); // 获取内置内存卡目录
        }
        return sdDir.toString();
    }

    public static final String ZXING_IMAGE_PATH = AppConfig.TEMP_PIC + PoliceApplication.getInstance().getResources().getString(R.string.app_name_pinyin) + "_zxing.jpg";
}
