...
public class QRCodeUtil {
    ...
    public static Bitmap createQRImage(Context context, String data, Bitmap logoBm) {
        try {
            ...
            int widthPix = getWidthPixels((Activity) context);
            widthPix = widthPix / 5 * 4;
            int heightPix = widthPix;

            //配置参数
            Map<EncodeHintType, Object> hints = new HashMap<EncodeHintType, Object>();
//            hints.put(EncodeHintType.CHARACTER_SET, "iso8859-1");//字节码类型
            hints.put(EncodeHintType.CHARACTER_SET, "utf-8");//base64类型
            //容错级别
