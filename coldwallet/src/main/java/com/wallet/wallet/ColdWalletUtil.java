...
import com.wallet.wallet.btc.BtcColdWallet;
...
public final class ColdWalletUtil {
     ...
     */
    public static ColdWallet createColdWallet(String walletName, String pwd) throws Exception {
     ...
     * @throws Exception 异常处理
     */
    public static ColdWallet createColdWallet(String walletName, boolean segWit, String pwd) throws Exception {
        SecureRandom secureRandom = new SecureRandom();
        DeterministicSeed ds = new DeterministicSeed(secureRandom, 128, "");
     ...
     * @throws Exception 异常处理
     */
    public static ColdWallet importMnemonic(String walletName, List<String> mnemonicCode, String pwd) throws Exception {
     ...
     * @throws Exception 异常处理
     */
    public static ColdWallet importMnemonic(String walletName, List<String> mnemonicCode, boolean segWit, String pwd) throws Exception {
        ...
        List<JnWallet> jnWallets = new ArrayList<>();
 ...
 //       jnWallets.add(new JnWallet(walletName, privateKeyEth, publicKeyEth, credentials.getAddress(), keystore, WalletType.A13));
     ...
     * BTC 各种操作
     *
     * @return BtcColdWallet
     */
    public static BtcColdWallet getBtcColdWallet() {
        return new BtcColdWallet();
    }

    /**
     * ETH 各种操作
     *
     * @return EthColdWallet
     */
    public static EthColdWallet getEthColdWallet() {
        return new EthColdWallet();
    }
