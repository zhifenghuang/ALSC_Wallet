...
import com.wallet.wallet.bean.EthFee;
...
import com.wallet.wallet.util.Util;
...
import static com.wallet.wallet.util.Constant.ETH_PATH;
import static com.wallet.wallet.util.Constant.ETH_RPC_URL;
...
public class EthColdWallet {
    ...
    private static Web3j web3j = Web3j.build(new HttpService(ETH_RPC_URL));
...
//    }
     ...
     * @return 钱包
     */
    public JnWallet importPrivateKey(String walletName, String password, String privateKey, WalletType walletType) throws Exception {
        ...
        return new JnWallet(walletName, privateKey, publicKey, credentials.getAddress(), keystore, walletType);
    }
    ...
    public JnWallet importKeystore(String walletName, String password, Object keystore, WalletType walletType) throws Exception {
        ObjectMapper objectMapper = ObjectMapperFactory.getObjectMapper();
        ...
        return new JnWallet(walletName, privateKey, publicKey, credentials.getAddress(), objectMapper.writeValueAsString(walletFile), walletType);
    }
