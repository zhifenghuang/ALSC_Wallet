...
import com.cold.wallet.databinding.ActivityExportPrivateBinding;
import com.wallet.entity.ColumnEditEntity;
import com.wallet.fragment.ExportPrivateFragment;
import com.wallet.fragment.ExportQcodeFragment;

import java.util.ArrayList;
import java.util.List;

public class ExportPrivateActivity extends BaseActivity implements View.OnClickListener {


    private ActivityExportPrivateBinding binding;
    private MyPagerAdapter pagerAdapter;
    private String mKeystore;

    public static void startActivity(Context context, String keystore) {
        Intent intent = new Intent(context, ExportPrivateActivity.class);
    ...
    protected void initViews(Bundle bundle) {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_export_private);
        binding.setClickListener(this);
        mKeystore = getIntent().getStringExtra("keystore");

        List<ColumnEditEntity> columns = new ArrayList<>();
        columns.add(new ColumnEditEntity(0, getString(R.string.c_cold_import_tab3)));
    ...
    private class MyPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public MyPagerAdapter(FragmentManager fm, List<ColumnEditEntity> columns) {
            ...
            fragments.add(ExportPrivateFragment.newInstance(bundle));
