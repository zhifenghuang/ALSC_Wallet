package com.cao.commons.widget.svprogresshud;
...
import com.cao.commons.widget.svprogresshud.listener.OnDismissListener;
import com.cao.commons.widget.svprogresshud.view.SVCircleProgressBar;
import com.cao.commons.widget.svprogresshud.view.SVProgressDefaultView;
...
public class SVProgressHUD {
    ...
    private static final long DISMISSDELAYED = 3000;
    ...
    public void dismiss() {
        try {
            ...
            isDismissing = true;
            //消失动画
            if (null != outAnim && null != outAnimListener) {
